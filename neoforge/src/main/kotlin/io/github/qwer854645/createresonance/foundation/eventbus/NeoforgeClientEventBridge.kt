        ...
        on<ScreenEvent.Init.Post>()
            .registerClient {
                ClientEvents.ScreenEvent.Init(
                    screen,
                    listenersList,
                    { addListener(it as net.minecraft.client.gui.components.events.GuiEventListener) },
                    { removeListener(it as net.minecraft.client.gui.components.events.GuiEventListener) },
                )
            }
    }
}
