...
import io.github.qwer854645.createresonance.content.records.hasAssignedUrl
import io.github.qwer854645.createresonance.content.records.isResonanceDisc
...
object ModItemAttributeTypes : PreFreezeCommonRegistry {
    val RESONANCE_DISC_URL_ASSIGNED =
        singleton("has_url_assigned") { stack, _ ->
            stack.isResonanceDisc() && stack.hasAssignedUrl()
        }
