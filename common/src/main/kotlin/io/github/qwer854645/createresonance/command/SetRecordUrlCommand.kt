package io.github.qwer854645.createresonance.command

import com.mojang.brigadier.CommandDispatcher
import com.mojang.brigadier.arguments.StringArgumentType
import com.mojang.brigadier.context.CommandContext
import io.github.qwer854645.createresonance.command.SetRecordUrlCommand.registerCommand
import io.github.qwer854645.createresonance.content.records.ResonanceDiscItem
import io.github.qwer854645.createresonance.content.records.RecordUtilities.setAudioUrl
...
object SetRecordUrlCommand : CommandEntry {
    ...
    private fun execute(ctx: CommandContext<CommandSourceStack>): Int {
        ...
        if (mainHandItem.item !is ResonanceDiscItem) {
