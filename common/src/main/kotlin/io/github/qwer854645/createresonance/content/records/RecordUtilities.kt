...
import io.github.qwer854645.createresonance.audio.player.AudioRequest
import io.github.qwer854645.createresonance.audio.stream.Ogg2PcmInputStream
...
object RecordUtilities {
    fun getAudioUrl(stack: ItemStack): String? {
        if (stack.item !is ResonanceDiscItem) return null
    ...
    fun setAudioUrl(
        ...
        if (stack.item !is ResonanceDiscItem) return
    ...
    fun AudioPlayer.playFromRecord(
        ...
        if (etherealRecord.item !is ResonanceDiscItem) return
            ...
            if (FFMPEGProvider.isProbeAvailable()) {
                ...
                (
                    "FFmpeg is correctly installed but it seems ffprobe is missing! \nIf it was installed by the mod" +
                        " please report this here https://github.com/qwer854645/create_resonance/issues.\n" +
...
fun ItemStack.isResonanceDisc(): Boolean = item is ResonanceDiscItem
